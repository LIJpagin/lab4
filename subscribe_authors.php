...
<?php include_once __DIR__ . '/components/head.php';
  ...
  $authors_id = array();
  $result2 = $connect->query("SELECT id_author FROM readers_authors WHERE id_reader = '".$reader_id."'");
...
<body class="subscribe_authors_body">
  <?php include_once __DIR__ . '/components/header.php' ?>
  <div style="margin-top: 70px;">
    <h6 style="text-align: center; margin-bottom: 15px;">Подписки на авторов</h6>
    ...
    <?php if (count($authors_id) == 0) : ?>
      ...
      <form style="margin-bottom: 0px;">
          <button class="search_button" formaction="search_authors.php">Перейти к поиску</button>
      </form>
    <?php endif; ?>
  </div>
</body>
